...
import { Agent } from "@microloop/agent";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@microloop/ai/compat";
import { getOAuthApiKey } from "@microloop/ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.microloop/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".microloop", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.microloop/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.microloop/agent/auth.json
 */
...
export const MICROLOOP_AGENT_DIR = join(homedir(), ".microloop", "agent");

/**
 * Get an AuthStorage instance backed by ~/.microloop/agent/auth.json

...
import type { AssistantMessage, Model } from "@microloop/ai";
...
vi.mock("@microloop/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@microloop/ai/compat")>();
	return {
		...actual,

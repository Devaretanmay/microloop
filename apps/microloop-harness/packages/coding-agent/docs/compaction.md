...
For TypeScript definitions in your project, inspect `node_modules/@microloop/coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@microloop/coding-agent";

...
| Package | Purpose |
|---------|---------|
| `@microloop/coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@microloop/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@microloop/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@microloop/coding-agent";
...
```typescript
import { isBashToolResult } from "@microloop/coding-agent";
...
```typescript
import { createLocalBashOperations } from "@microloop/coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@microloop/coding-agent";
...
```typescript
import { SessionManager } from "@microloop/coding-agent";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@microloop/ai";
...
```typescript
import type { AutocompleteItem } from "@microloop/tui";
...
```typescript
import { Box, Text } from "@microloop/tui";
...
```typescript
import { withFileMutationQueue } from "@microloop/coding-agent";
...
import { Type } from "typebox";
import { StringEnum } from "@microloop/ai";
import { Text } from "@microloop/tui";
...
**Important:** Use `StringEnum` from `@microloop/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@microloop/coding-agent";
...
```typescript
import { createBashTool } from "@microloop/coding-agent";
...
```typescript
import { keyHint } from "@microloop/coding-agent";
...
```typescript
import { Text, Component } from "@microloop/tui";
...
import { matchesKey } from "@microloop/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@microloop/coding-agent";

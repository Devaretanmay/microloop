...
```bash
npm install @microloop/coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@microloop/coding-agent";
...
The `Agent` class (from `@microloop/agent`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@microloop/ai";
import { AuthStorage, ModelRegistry } from "@microloop/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@microloop/coding-agent";
...
```typescript
import { createAgentSession } from "@microloop/coding-agent";
...
import { createAgentSession, defineTool } from "@microloop/coding-agent";
...
```typescript
import type { InlineExtension } from "@microloop/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@microloop/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@microloop/coding-agent";

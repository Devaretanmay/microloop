...
import type { Transport } from "@microloop/ai";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.MICROLOOP_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.MICROLOOP_HARDWARE_CURSOR === "1";
	}

...
import type { ImageContent, TextContent } from "@microloop/ai";
import { getCapabilities, getImageDimensions, hyperlink, imageFallback } from "@microloop/tui";
...
export function getTextOutput(
	...
	let output = textBlocks.map((c) => sanitizeBinaryOutput(stripVTControlCharacters(c.text || "")).replace(/\r/g, "")).join("\n");

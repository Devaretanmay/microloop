...
import { Agent, type AgentMessage, type ThinkingLevel } from "@microloop/agent";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@microloop/ai/compat";

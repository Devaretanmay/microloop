...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/microloop-ai/microloop/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.MICROLOOP_PACKAGE_DIR;
	if (envDir) {
...
export const PACKAGE_NAME: string = pkg.name || "@microloop/harness";
export const APP_NAME: string = "microloop";
export const APP_TITLE: string = "Microloop";
export const CONFIG_DIR_NAME: string = pkg.microloopConfig?.configDir || ".microloop";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., MICROLOOP_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://microloop.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.MICROLOOP_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.microloop/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.microloop/agent/) */

import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@microloop/ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@microloop/tui";

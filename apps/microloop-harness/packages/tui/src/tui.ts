...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.MICROLOOP_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.MICROLOOP_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
	...
	private doRender(): void {
		...
		const debugRedraw = process.env.MICROLOOP_DEBUG_REDRAW === "1";
		...
		// Configurable via setClearOnShrink() or MICROLOOP_CLEAR_ON_SHRINK=0 env var
		...
		if (process.env.MICROLOOP_TUI_DEBUG === "1") {
